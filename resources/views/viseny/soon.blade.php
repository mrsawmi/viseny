...
<!-- Mirrored from moderniz.ir/demo/unishop/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 16:31:50 GMT -->
<!-- Added by HTTrack -->
<meta http-equiv="content-type" content="text/html;charset=utf-8"/><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <title>قالب فروشگاهی ویسنیآرت | صفحه بزودی
    </title>
    <!-- SEO Meta Tags-->
    <meta name="description" content="VisenyArt - Universal E-Commerce Template">
    <meta name="keywords"
    ...
    <link id="mainStyles" rel="stylesheet" media="screen" href="css/rtl.css">
    <!-- Modernizr-->
...
<div class="offcanvas-container" id="shop-categories">
    <div class="offcanvas-header">
        <h3 class="offcanvas-title">فروشگاه محصولات</h3>
    </div>
...
<div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html">
    ...
    <nav class="offcanvas-menu">
        <ul class="menu">
            <li class="has-children"><span><a href="index-2.html"><span>Home</span></a><span
            ...
            <li class="has-children"><span><a href="#"><span>Pages</span></a><span
                ...
                <ul class="offcanvas-submenu">
                    ...
                    <li><a href="mobile-app.html">VisenyArt Mobile App</a></li>
...
<div class="offcanvas-wrapper">
    ...
    <div class="row no-gutters">
        <div class="col-md-6 fh-section" style="background-image: url(bg.jpg);"><span class="overlay"
                                                                                      style="background-color: #374250; opacity: .85;"></span>
            <div class="d-flex flex-column fh-section py-5 px-3 justify-content-between">
                <div class="w-100 text-center">
                    <div class="d-inline-block mb-5" style="width: 325px;"><img class="d-block"
                                                                                src="soon-logo.jpg"
                                                                                alt="VisenyArt"></div>
                    <h1 class="text-white text-normal mb-2">بزودی میاییم ...</h1>
                    <h5 class="text-white text-normal opacity-80 mb-4">وب سایت ما در حال ساخته شدن است. این در زندگی
                        زنده است:</h5>
                    <div class="countdown countdown-inverse" data-date-time="02/30/2019 12:00:00">
                        <div class="item">
                    ...
                    <div class="pt-3 hidden-md-up"><a class="btn btn-primary scroll-to" href="#notify"><i
                                    class="icon-bell"></i>&nbsp;من را باخبر کن !</a></div>
                </div>
                <div class="w-100 text-center">
                    <p class="text-white mb-2">0938-1800820</p><a class="navi-link-light"
                                                                  href="mailto:shayanmayeli@gmail.com">shayanmayeli@gmail.com</a>
                    <div class="pt-3"><a class="social-button shape-circle sb-facebook sb-light-skin"
                                         href="https://facebook.com/VisenyArt"><i
                                    class="socicon-facebook"></i></a><a
                                class="social-button shape-circle sb-twitter sb-light-skin"
                                href="https://twitter.com/VisenyArt"><i
                                    class="socicon-twitter"></i></a><a
                                class="social-button shape-circle sb-instagram sb-light-skin"
                                href="https://instagram.com/VisenyArt"><i
            ...
            <div class="d-flex flex-column fh-section py-5 px-3 justify-content-center align-items-center">
                <div class="text-center" style="max-width: 500px;">
                    ...
                    <h5 class="text-normal text-muted mb-4">
                        اولین و بزرگترین مجموعه
                        عرضه صنایع دستی در ایران
                    </h5>
                    <form method="post" action="save.php">
                        <div class="form-group">
                            <input class="form-control" name="userName" type="text" placeholder="نام" required>
                        </div>
                        <div class="form-group">
                            <input class="form-control" name="userEmail" type="email" placeholder="آدرس ایمیل" required>
                        </div>
                        <button class="btn btn-primary" data-toast="" data-toast-type="success"
                                data-toast-position="topRight" data-toast-icon="icon-circle-check"
                                data-toast-title=" اطلاع رسانی " data-toast-message="به لیست اضافه شدید.">
                            <i class="icon-mail"></i>&nbsp;ارسال
                        </button>
                    </form>
                </div>
            </div>
...
<!-- Mirrored from moderniz.ir/demo/unishop/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Oct 2018 16:32:00 GMT -->
</html>